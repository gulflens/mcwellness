...
- **Locations** — list; each shows Makani, entrance pin, parking pin, gate pin, access notes; "check the pin" opens a map to drag the marker (part two of the walk's fixes; until then the coordinate boxes)
