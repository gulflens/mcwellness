...
your record are gone from our systems, and the account that opened your record
in the client portal has been closed — or, where that account belongs to
somebody who works at {{practice_legal_name}}, its link to your record has been
ended and the account itself is untouched. The record of your sessions has gone
with them:
...
Three things are kept, and each only because the law or the safety of our own
records requires it. **The measurements stay, with nobody attached to them** —
the before-and-after ratings, the readings from the sessions and their quality
scores, the figures from a brain map and the total from a questionnaire —
because they are numbers that no longer say whose they were, and we use them to
understand our own work. **Invoices and receipts stay for five
...
{{practice_legal_name}} can bring back what has gone. If you have a question
about this, reply to the message this letter came with, or contact us
{{practice_contact}}. You may also complain to the UAE Data Office.
