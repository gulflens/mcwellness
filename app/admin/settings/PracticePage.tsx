        ...
        <div className="practice">
          ...
          <section className="practice__group">
            ...
            <p className="small muted">
              ...
              practice holds for corporate tax and is never printed as a VAT one. While the practice is
              not registered for VAT, its invoices carry no VAT and show one figure; recording a
